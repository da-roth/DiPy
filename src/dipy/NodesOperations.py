...
class SumNode(Node):
    ...
    def GetVariableList(self):
        variableStrings = [var for op in self.operands for var in op.GetVariableList()]
...
class IfNode(Node):
    ...
    def GetVariableList(self):
        variableStrings = [self.condition.GetVariableList(), self.true_value.GetVariableList(), self.false_value.GetVariableList()]
        return self.Flatten_and_extract_unique([x for x in variableStrings if x])
